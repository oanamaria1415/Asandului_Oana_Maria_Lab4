...
namespace Asandului_Oana_Maria_Lab4
{
    public partial class PricePredictionModel
    {
        public const string RetrainFilePath =  @"D:\Dezvoltare Big Data\Asandului_Oana_Maria_Lab4\fare-train-data.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=4,NumberOfIterations=867,MinimumExampleCountPerLeaf=20,LearningRate=0.23071185407582137,LabelColumnName=@"fare_amount",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.9999997766729865,FeatureFraction=0.9396975831949779,L1Regularization=2E-10,L2Regularization=0.9524175039983221},MaximumBinCountPerFeature=396}));
